...
function Navbar() {
  return (
    <>
      <div className="flex items-center px-8 justify-between py-1 sm:px-12 z-20 mt-3 font-['Neue_Montreal']  ">
        ...
        <div className=" hidden lg:flex ">
          {["Services", "Our work", "About us", "Insights", "Contact us"].map(
            (item, index) => (
              <a
                className={`ml-5 font-light  cursor-pointer ${
                  index == 4 && "ml-56"
        ...
        <div className="responsive links"></div>
      </div>
    </>
  );
}
